...
#     https://medium.com/@rachelvfmurphy/automating-azure-authentication-service-principals-and-managed-identities-with-powershell-82009cd4239f
#     https://github.com/rachelf27/AzurePowerShellAutomation/blob/develop/Connect/Check-MyAzAcntConnect.psm1
...
function Get-MyAzAccountFunc {
    ...
    $variablesPath = "C:\Users\t983902\OneDrive - Telenor\Code\GitHub\Powershell\Azure\ServicePrincipal\CustomVariables.txt"
    ...
    try {
        ...
        #Get-AzSubscription -SubscriptionId $variables['subscriptionId']
